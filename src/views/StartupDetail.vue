    ...
    <div class="mt-6A border-t border-white/10">
      <dl class="divide-y divide-white/10">
        ...
        <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <dd class="mt-1 text-sm leading-6 text-gray-400 sm:col-span-2 sm:mt-0">{{ startup.fte_number }}</dd>
        </div>
        <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
...
const startup = computed(() => {
  return store.getters.getStartupByName(route.params.startupName);
});
